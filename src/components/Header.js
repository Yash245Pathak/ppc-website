    ...
    return (
        <section className='w-full bg-white text-[darkblue] py-4 shadow-2xl sticky top-0 z-50'>
            <div className='flex justify-between items-center relative'>
                <div className='text-[30px] pl-16 font-bold hover:scale-110 transition-all duration-500 cursor-pointer'>
                ...
                <div className='text-[30px] md:hidden cursor-pointer pr-16' onClick={()=> setOpen(!open)}>
